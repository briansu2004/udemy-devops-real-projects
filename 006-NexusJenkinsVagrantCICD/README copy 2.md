...
d. Follow the **wizard** and reset our password. Select **"Enable anonymous access"** and click **"Next"**->**"Finish"** to complete the guide.</br>
...
**Password:**  *(Type our password)* </br>
**Confirm password:**  *(Type the same password weentered above)*  </br>
**Status:** Active</br>
**Roles:** nx-admin</br> 

## 3. Configure Jenkins
a. Login to our Jenkins website (http://0.0.0.0:8080) and go to **"Manage Jenkins"** -> **"Manage Credentials"** ->  **"System"** -> **"Global credentials (unrestricted)"** -> Click **"Add Credentials"** and weshould fill out the page in below selection: </br>
...
**Password:** *(Type the password weset in previous step)*</br>
**ID:** nexus</br>
...
e. Add `https://github.com/devops2021/devopsdaydayup.git` in **"Repository URL"** field</br>
f. Select our github credential in **"Credentials"**</br>
...
wecan login to the Nexus website (http://0.0.0.0:8081) and go to **"Browse"** section, and then click **"maven-nexus-repo"**, weshould be able to see the artifacts just uploaded.
