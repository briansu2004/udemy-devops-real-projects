...
```dos
C:\Code\MyDevOps\DevOpsDayDayUp\004-TerraformDockerDeployment>docker ps
CONTAINER ID   IMAGE                          COMMAND             CREATED          STATUS                             PORTS                                                            NAMES 
01b07dbad94d   gitlab/gitlab-ce:15.3.5-ce.0   "/assets/wrapper"   44 seconds ago   Up 41 seconds (health: starting)   0.0.0.0:80->80/tcp, 0.0.0.0:443->443/tcp, 0.0.0.0:2222->22/tcp   gitlab

C:\Code\MyDevOps\DevOpsDayDayUp\004-TerraformDockerDeployment>docker exec -it 01 cat /etc/gitlab/initial_root_password
...
Password: 7O3EbAAcMADSxDWjpZOfQLVQ1m7Bscfn+ffCKBGEl/A=
...
SET YOUR_GITLAB_DOMAIN=example20221106.com

GitLab token

`glpat-F8kAeTUA71kRJhusxybK`

Project ID: 34

https://<your gitlab server url>/api/v4/projects/<your project id>/terraform/state/old-state-name

<https://gitlab.example20221106.com/api/v4/projects/34/terraform/state/old-state-name>

`docker cp gitlab:/etc/gitlab/ssl/gitlab.example20221106.com.crt ./`

glpat-WUZ-zyvV4ueeRxEh1ot5

<https://gitlab.example20221106.com/api/v4/projects/35/terraform/state/old-state-name>
